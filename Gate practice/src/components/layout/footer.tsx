...
const Footer = () => {
  return (
    <>
      <div className="pt-20">
        <div className="w-10/11 mx-auto grid grid-cols-2">
          <div>
            <img
            ...
            <div>
              ...
              <div className="capitalize mt-4 flex flex-col gap-2 transition-all ease-in-out duration-100">
                {navMenus.map((k, ind) => (
                  <div key={ind}>
                    <a
                      className="hover:text-amber-100 text-sm hover:transform-x-5"
                      href={`/${k}`}
                    >
                      {k}
                    </a>
        ...
        <div className="flex justify-end my-8 opacity-85">
          <div className="w-10/11 mx-auto flex justify-between gap-8">
            <div className="flex gap-4">

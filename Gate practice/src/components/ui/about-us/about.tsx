const About = () => {
  return (
    <>
      <div className="py-40 border-t border-t-zinc-800 rounded-4xl text-zinc-300">
        <div className="w-10/11 mx-auto flex justify-center gap-50">
          <div className="w-1/2">
          ...
          <div className="w-1/2 relative z-0">
            ...
            <div className="p-4 bg-black absolute -top-20 -right-14 z-20">
              <img
                className="w-70 h-50 rounded-2xl"
